...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-pink elevation-4 sidebar-no-expand">
        ...
        <img src="<?php echo validate_image($_settings->info('j'))?>" alt="Store Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width: 1.5rem;height: 1.5rem;max-height: unset">
